...
drawings:
  ...
  presenterOnly: false
  syncAll: false
exportFilename: talk-2025-04-08-dev-day-conference
...
info: |
  ...
  This project contains the slides for my talk titled `Playing with 3D on the Web & Beyond` on 2025-04-08
  at the [Dev Day](https://www.devday.de/) 2025 conference in Dresden.
