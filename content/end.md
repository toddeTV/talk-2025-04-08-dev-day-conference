...
<div class="flex flex-row gap-8 mt-8">
    ...
    <div
        ...
        v-mark="{ at: 0, color: '#26ab7a', type: 'box' }"
    >
        <QRCode value="https://github.com/toddeTV/talk-2025-04-08-dev-day-conference" :size="128" class="mb-6" />
        <div class="flex flex-col gap-2">
            <div class="whitespace-nowrap">
            ...
            <div class="w-full text-sm">
                <mdi-github class="baseColor mx-2" />
                <MyLink to="https://github.com/toddeTV/talk-2025-04-08-dev-day-conference">https://github.com/toddeTV/talk-2025-04-08-dev-day-conference</MyLink>
            </div>
        </div>
    </div>
</div>
